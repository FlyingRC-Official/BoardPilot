...
- SourceVersion and review-context service hydration now prefer persisted Product, SourceVersion, Source, Question, artifact, chunk, embedding, candidate, and evidence rows over stale in-memory state before seeding ingestion or review services, and SourceVersion hydration rejects persisted versions whose persisted Source parent is missing.
