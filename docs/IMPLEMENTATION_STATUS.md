...
- SourceVersion and review-context service hydration now prefer persisted Product, SourceVersion, Source, artifact, chunk, embedding, candidate, and evidence rows over stale in-memory state before seeding ingestion or review services.
